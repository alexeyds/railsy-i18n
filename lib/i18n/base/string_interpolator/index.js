...
module.exports = class StringInterpolator {
  interpolate(string, replacements) {
    if (typeof string === "string") {
      ...
      return { 
        interpolated: string, 
        unusedPlaceholders: validation.unusedReplacements, remainingPlaceholders: validation.remainingPlaceholders, 
        undefinedPlaceholders: validation.undefinedReplacements
      };
    } else {
